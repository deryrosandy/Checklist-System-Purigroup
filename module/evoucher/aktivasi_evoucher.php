<?php 
	...
	$act_evoucher = $db->evoucher_customer()
        ->order("id DESC");
?>
									...
									<div class="panel-body">
										<div class="table-responsive">
											...
											<table data-sortable id="list_history_voucher" class="table table-responsive table-hover table-striped" width="100%">
												...
												<tbody>
												<?php $n=1; ?>
												<?php foreach ($act_evoucher as $act){ ?>
													<tr class="odd gradeX">
														<?php /* <td><input type="checkbox" id="id_req[]" name="id_req[]" value="<?php echo $vc['id']; ?>"></td> */ ?>
														<td><?php echo $n; ?></td>
														<td><?php echo strtoupper($act->voucher['barcode']); ?></td>
														<td><?php echo number_format($act->voucher['nominal'],0,",","."); ?></td>
                                                        <td><?php echo ucwords($act['name']); ?></td>
                                                        <td><?php echo strtolower($act['email']); ?></td>
                                                        <td><?php echo ucwords(tgl_indo($act['created_at'])); ?></td>
														<td><?php echo ucwords($act->users['first_name']); ?></td>
													</tr>
