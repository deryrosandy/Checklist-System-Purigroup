						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="controls col-sm-6">
										<input type="text" name="first_name" class="form-control required"  title="Insert First Name" placeholder="Insert First Name">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="controls col-sm-6">
										<input type="text" name="last_name" class="form-control"  title="last_name" placeholder="Insert Last Name">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<select name="gol-pengguna" class="form-control form-chosen required" data-placeholder="">
											...
											<option value="manager pengganti">Manager Pengganti</option>
								...
								<div class="form-group">
									...
									<div class="controls col-sm-6">
										<input name="user-status" value="1" class="boot-switch2" type="checkbox" data-on-color="warning" data-off-color="danger">
									</div>
								</div>
