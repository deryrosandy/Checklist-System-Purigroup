					...
					<div class="row">
						<div class="col-md-12">
							<ul class="nav nav-pills">
								<li><a href="javascript:void(0);"><strong>Input Checklist</a></strong></li>
								<li><a href="lihat-checklist-me.php"><strong>Lihat Checklist</a></strong></li>
								<li class="active"><a href="checklist-backup-db.php"><strong>Checklist Backup DB</a></strong></li>
							</ul>
							<div class="tab-content">
								<div class="panel panel-info">
									<div class="panel-heading">
										<h3 class="panel-title">Checklist Backup Database</h3>
									</div>
								</div>
															...
															<div class="panel-collapse collapse" id="collapse<?php echo $item['id']; ?>">
																<div class="panel-body">
																	<div class="row">
																		...
																		<!-- Jika Area Checklist Service Ac -->
																				...
																				<div class="col-lg-12">
																					<div class="row">
																						<div class="btn-action pull-right">
																							...
																							<button type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-warning add_new">Add New</button>
																		...
																		<?php if($item_area_id == 11){ ?>
																			...
																			<div class="table-responsive form_in_ll form_in_me_shower">
																				<table class="table">
																					<?php if(($item['id'] != 131) && ($item['id'] != 132) && ($item['id'] != 133) && ($item['id'] != 134) && ($item['id'] != 135) && ($item['id'] != 136) && ($item['id'] != 137) && ($item['id'] != 138)) { ?>
																						<tbody>
																							<tr style="width:80%;">
																			...
																			<div class="table-responsive form_in_ll form_in_me_fas">																																										
																					...
																					<div class="col-lg-6" style="">
																						<div class="row">
																							...
																							<div class="col-sm-12 form-group" style="">
																								<div class="controls col-lg-12" width="">
																									<?php if(count($cekrow) > 0){ ?>
																										<button disabled type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist11">Simpan</button>
																									<?php }else{ ?>
																										<button type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist11">Simpan</button>
																									<?php } ?>
																								</div> 
																							</div>
																							<!--</form>-->
																					...
																					<div class="col-lg-6" style="">
																						<div class="row">
																							...
																							<div class="col-sm-12 form-group" style="">
																								<div class="controls col-lg-12" width="">
																									<?php if(count($cekrow) > 0){ ?>
																										<button disabled type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist12">Simpan</button>
																									<?php }else{ ?>
																										<button type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist12">Simpan</button>
																									<?php } ?>
																								</div> 
																							</div>
																						</div>
																					...
																					<div class="col-lg-6" style="">
																						<div class="row">
																							...
																							<div class="col-sm-12 form-group" style="">
																								<div class="controls col-lg-12" width="">
																									<?php if(count($cekrow) > 0){ ?>
																										<button disabled type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist14">Simpan</button>
																									<?php }else{ ?>
																										<button type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist14">Simpan</button>
																									<?php } ?>
																								</div> 
																							</div>
																							<!--</form>-->
																					...
																					<div class="col-lg-6" style="">
																						<div class="row">
																							...
																							<div class="col-sm-12 form-group" style="">
																								<div class="controls col-lg-12" width="">
																									<?php if(count($cekrow) > 0){ ?>
																										<button disabled type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist16">Simpan</button>
																									<?php }else{ ?>
																										<button type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist16">Simpan</button>
																									<?php } ?>
																								</div> 
																							</div>
																							<!--</form>-->
																					...
																					<div class="col-lg-6" style="">
																						<div class="row">
																							...
																							<div class="col-sm-12 form-group" style="">
																								<div class="controls col-lg-12" width="">
																									<?php if(count($cekrow) > 0){ ?>
																										<button disabled type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist18">Simpan</button>
																									<?php }else{ ?>
																										<button type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist18">Simpan</button>
																									<?php } ?>
																								</div> 
																							</div>
																							<!--</form>-->
																					...
																					<div class="col-lg-6" style="">
																						<div class="row">
																							...
																							<div class="col-sm-12 form-group" style="">
																								<div class="controls col-lg-12" width="">
																									<?php if(count($cekrow) > 0){ ?>
																										<button disabled type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist20">Simpan</button>
																									<?php }else{ ?>
																										<button type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist20">Simpan</button>
																									<?php } ?>
																								</div> 
																							</div>
																							<!--</form>-->
																					...
																					<div class="col-lg-6" style="">
																						<div class="row">
																							...
																							<div class="col-sm-12 form-group" style="">
																								<div class="controls col-lg-12" width="">
																									<?php if(count($cekrow) > 0){ ?>
																										<button disabled type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist22">Simpan</button>
																									<?php }else{ ?>
																										<button type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist22">Simpan</button>
																									<?php } ?>
																								</div> 
																							</div>
																							<!--</form>-->
																					...
																					<div class="col-lg-6" style="">
																						<div class="row">
																							...
																							<div class="col-sm-12 form-group" style="">
																								<div class="controls col-lg-12" width="">
																									<?php if(count($cekrow) > 0){ ?>
																										<button disabled type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist23">Simpan</button>
																									<?php }else{ ?>
																										<button type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist23">Simpan</button>
																									<?php } ?>
																								</div> 
																							</div>
																							<!--</form>-->
																				...
																				<div class="col-lg-12">
																					<div class="row">
																						<div class="btn-action pull-right">
																							<input type="hidden" name="id" value="<?php echo $item["id"]; ?>" data-id="<?php echo $item["id"]; ?>" />
																							<a href="#collapse<?php echo $item['id']; ?>" data-parent="#accordion" data-toggle="collapse" onClick="" class="btn btn-default">Close</a>
																							<?php /* <button type="submit" onClick="" id="submit_btn_hk" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary submit_checklist">Simpan</button> */ ?>
																							<!--<a class="btn btn-primary btn-sm">Simpan</a>-->
																							<br/>
																							<br/>
																						</div>
																					...
																					<div class="col-lg-12" style="">
																						<div class="row">
																							...
																							<div class="col-sm-12 form-group" style="">
																								<div class="controls col-lg-12" width="">
																									<?php if(count($cekrow) > 0){ ?>
																										<button disabled type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist11_1">Simpan</button>
																									<?php }else{ ?>
																										<button type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist11_1">Simpan</button>
																									<?php } ?>
																								</div> 
																							</div>
																							<!--</form>-->
																					...
																					<div class="col-lg-12" style="">
																						...
																						<div class="row">
																							...
																							<div class="col-sm-12 form-group" style="">
																								<div class="controls col-lg-12" width="">
																									<?php if(count($cekrow) > 0){ ?>
																										<button disabled type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist23_2">Simpan</button>
																									<?php }else{ ?>
																										<button type="submit" onClick="" id="" name="submit" data-id="<?php echo $item["id"]; ?>" onClick="" class="btn btn-primary btn-mini submit_checklist23_2">Simpan</button>
																									<?php } ?>
																								</div> 
																							</div>
																						</div>
